...
def launchTestJobs(pipeline, testFilter, globalVars)
{
    ...
    x86SlurmTestConfigs = [
        ...
        // Kimi K3 at TP8 needs all 8 GPUs of a B300 node; the 4-GPU stages above cannot host it.
        "DGX_B300-8_GPUs-PyTorch-Post-Merge-1": ["auto:dgx-b300-flex", "l0_dgx_b300", 1, 1, 8, 1, true],
